          ...
          >
            <div className="flex-1 px-4 pt-6 pb-32">
              ...
              <TabsContent value="wallet" className="h-full">
                <div ref={walletContentRef} className="scroll-container h-full">
                  <WalletLayout />
                </div>
              </TabsContent>
            ...
            <div className="fixed bottom-1 left-1/2 -translate-x-1/2 z-50 w-[95%] items-center">
              <div className="rounded-2xl shadow-md bg-white dark:bg-zinc-900 border p-2.5 items-center">
                <TabsList className="grid grid-cols-3 w-full bg-white dark:bg-zinc-900">
